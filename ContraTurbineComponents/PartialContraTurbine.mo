...
partial model PartialContraTurbine
  ...
  CRWT.ContraTurbineComponents.ContraTurbineTorque turbineTorque(rho=rho, r_t=
        r_t) annotation (Placement(transformation(extent={{10,-10},{30,10}})));
