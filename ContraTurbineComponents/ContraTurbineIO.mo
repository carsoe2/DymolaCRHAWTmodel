...
model ContraTurbineIO "Energy based, polynomial approximation for cp"
  ...
  CRWT.ContraTurbineComponents.ContraTurbineInnerIO coreElement(
    c1=data.c1,
    c2=data.c2,
    c3=data.c3,
    c4=data.c4,
  ...
  replaceable Contra_2MW_withPitch data
    constrainedby Contra_2MW_withPitch(lambda=lambda, beta=beta)
